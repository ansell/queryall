...
public class BlacklistControllerTest
{
    ...
    public void testGetPermanentIPBlacklistNonEmpty()
    {
        ...
        Collection<String> permanentBlacklist = this.testBlacklistController.getPermanentIPBlacklist();
    ...
    public void testIsEndpointBlacklistedDefaultParametersFalse()
    {
        ...
        // Test the default parameter version of this method, which assumes 5 request failures needed to blacklist an endpoint
    ...
    public void testIsEndpointBlacklistedSpecificParameters()
    {
        ...
        Assert.assertTrue(this.testBlacklistController.isEndpointBlacklisted("http://test.example.org/endpoint/bad/1", blacklistMaxAccumulatedFailures, blacklistResetPeriodMilliseconds, blacklistResetClientBlacklistWithEndpoints));    
    }

...
public class QueryallContentNegotiatorTest
{
    ...
    public void testGetContentNegotiatorPreferredRDFXML()
    {
        ...
        Assert.assertEquals("application/rdf+xml", testContentNegotiator.getBestMatch("application/rdf+xml")
                .getMediaType());
        ...
        Assert.assertEquals("application/rdf+xml", testContentNegotiator
                .getBestMatch("application/rdf+xml,text/rdf+n3").getMediaType());
    }
    ...
    public void testGetContentNegotiatorPreferredN3()
    {
        ...
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("application/rdf+xml,text/rdf+n3")
                .getMediaType());
        ...
        Assert.assertEquals("text/rdf+n3",
                testContentNegotiator.getBestMatch("text/n3,application/n3,application/rdf+n3").getMediaType());
        
        Assert.assertEquals("text/rdf+n3",
                testContentNegotiator.getBestMatch("text/rdf+n3,text/n3,application/n3,application/rdf+n3")
                        .getMediaType());
    }
    ...
    public void testGetContentNegotiatorN3WithPreferredRDFXML()
    {
        ...
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/turtle")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/x-turtle")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,text/html").getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/html")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/xhtml+xml")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/json")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/rdf+json")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/ld+json")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,text/x-nquads")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,text/nquads").getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/x-trig")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/trig")
                .getMediaType());
        
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("text/rdf+n3,application/trix")
                .getMediaType());
    ...
    public void testGetContentNegotiatorRDFXMLWithPreferredN3()
    {
        ...
        Assert.assertEquals("text/rdf+n3", testContentNegotiator.getBestMatch("application/rdf+xml,text/n3")
                .getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/rdf+n3").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/n3").getMediaType());
        
        // Test RDFXML against other possibilities while it is not preferred to make sure it is
        // second in line after N3
        Assert.assertEquals("application/rdf+xml", testContentNegotiator
                .getBestMatch("application/rdf+xml,text/turtle").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/turtle").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/x-turtle").getMediaType());
        
        Assert.assertEquals("application/rdf+xml", testContentNegotiator.getBestMatch("application/rdf+xml,text/html")
                .getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/html").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/xhtml+xml").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/json").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/rdf+json").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/ld+json").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,text/x-nquads").getMediaType());
        
        Assert.assertEquals("application/rdf+xml", testContentNegotiator
                .getBestMatch("application/rdf+xml,text/nquads").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/x-trig").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/trig").getMediaType());
        
        Assert.assertEquals("application/rdf+xml",
                testContentNegotiator.getBestMatch("application/rdf+xml,application/trix").getMediaType());
        
        Assert.assertEquals("application/rdf+xml", testContentNegotiator.getBestMatch("application/rdf+xml,text/plain")
                .getMediaType());
    ...
    public void testGetContentNegotiatorAnythingElseWithPreferredTextPlain()
    {
        ...
        // it
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("application/rdf+xml,text/plain")
                .getMediaType());
        ...
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/rdf+n3")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/n3")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,text/turtle").getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/turtle")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/x-turtle")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,text/html").getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/html")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/xhtml+xml")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/json")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/rdf+json")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/ld+json")
                .getMediaType());
        ...
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/x-trig")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/trig")
                .getMediaType());
        
        Assert.assertEquals("text/plain", testContentNegotiator.getBestMatch("text/plain,application/trix")
                .getMediaType());
    ...
    public void testGetResponseContentTypeStarSlashStar()
    {
        ...
        Assert.assertEquals("application/rdf+xml", QueryallContentNegotiator.getResponseContentType("*/*",
                "dummy-agent/1.0", testContentNegotiator, "text/fake"));
        ...
        Assert.assertEquals("text/rdf+n3", QueryallContentNegotiator.getResponseContentType("*/*", "dummy-agent/1.0",
                testContentNegotiator, "text/fake"));
    ...
    public void testGetResponseContentTypeFirefoxDefault()
    {
        ...
        testHtmlBrowserDefaults("Firefox", "Mozilla/5.0 (X11; Linux i686; rv:7.0.1) Gecko/20100101 Firefox/7.0.1",
    ...
    {
        String defaultOperaDesktopAccept =
                "text/html, application/xml;q=0.9, application/xhtml+xml, image/png, image/jpeg, image/gif, image/x-xbitmap, */*;q=0.1";
        
        testHtmlBrowserDefaults("Opera", "Opera/9.80 (Macintosh; Intel Mac OS X; U; en) Presto/2.2.15 Version/10.00",
                defaultOperaDesktopAccept);
    }
    ...
    {
        String defaultSafariDesktopAccept =
                "application/xml,application/xhtml+xml,text/html;q=0.9,text/plain;q=0.8,image/png,*/*;q=0.5";
        
        testHtmlBrowserDefaults(
                "Safari",
    ...
    {
        String defaultChromeDesktopAccept =
                "application/xml,application/xhtml+xml,text/html;q=0.9, text/plain;q=0.8,image/png,*/*;q=0.5";
        
        testHtmlBrowserDefaults("Safari",
    ...
    public void testGetResponseContentTypeTabulatorDefault()
    {
        ...
        testRdfBrowserDefaults("Tabulator", "Mozilla/5.0 (compatible)", defaultTabulatorAccept);
    }
    ...
    {
        String defaultJenaAccept =
                "application/rdf+xml, application/xml; q=0.8, text/xml; q=0.7, application/rss+xml; q=0.3, */*; q=0.2";
        
        testRdfBrowserDefaults("Jena", "Java/6", defaultJenaAccept);
    }
    
    /**
     * Test the behaviour of the QueryallContentNegotiator against a OpenLink RDF Browser default accept header
     * 
     * http://richard.cyganiak.de/blog/2008/03/what-is-your-rdf-browsers-accept-header/
     * 
     */
    ...
    {
        String defaultSindiceAccept =
                "application/rdf+xml, application/xml;q=0.6, text/xml;q=0.6";
        
        testRdfBrowserDefaults("Sindice", "SindiceBot/1.0", defaultSindiceAccept);
    }
    ...
    private void testHtmlBrowserDefaults(String browserName, String typicalUserAgent, String defaultAcceptHeader)
    {
        ...
        Assert.assertEquals(
                ...
                "application/rdf+xml", QueryallContentNegotiator.getResponseContentType(defaultAcceptHeader,
                        typicalUserAgent, testContentNegotiator, "text/fake"));
     ...
     * application/rdf+xml versus application/xhtml+xml
     */
    private void testRdfBrowserDefaults(String browserName, String typicalUserAgent, String defaultAcceptHeader)
    {
        testContentNegotiator = QueryallContentNegotiator.getContentNegotiator("text/html");
        ...
        Assert.assertNotSame(
                ...
                "text/html", QueryallContentNegotiator.getResponseContentType(defaultAcceptHeader, typicalUserAgent,
                        testContentNegotiator, "text/html"));
        ...
        Assert.assertNotSame(
                ...
                "text/html", QueryallContentNegotiator.getResponseContentType(defaultAcceptHeader,
                        typicalUserAgent, testContentNegotiator, "text/html"));
        ...
        Assert.assertNotSame(browserName

...
public class ContentTypeNegotiator {
	...
	public MediaRangeSpec getBestMatch(String accept) {
		MediaRangeSpec result = getBestMatch(accept, null);
	...
	public MediaRangeSpec getBestMatch(String accept, String userAgent) {
		...
		if(_DEBUG)
		{
			log.debug("ContentTypeNegotiator: getBestMatch accept="+accept+" userAgent="+userAgent);
		}
		...
		if(_DEBUG)
		{
			log.debug("ContentTypeNegotiator: getBestMatch overriddenAccept="+overriddenAccept);
		}
		
		MediaRangeSpec result = new Negotiation(toAcceptRanges(overriddenAccept)).negotiate();
		
		if(_INFO)
		{
			log.info("ContentTypeNegotiator: getBestMatch result="+result);
		}
	...
	private class AcceptHeaderOverride {
		...
		boolean matches(String acceptHeader, String userAgentHeader) {
			return (userAgentPattern == null 
							|| (userAgentHeader != null && !userAgentHeader.equals("")

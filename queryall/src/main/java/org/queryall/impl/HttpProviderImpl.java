		...
		HttpProvider , SparqlProvider
{
    ...
    public boolean toRdf(Repository myRepository, URI keyToUse, int modelVersion) throws OpenRDFException
    {
        ...
        try
        {
		    ...
		    con.add(providerInstanceUri, HttpProviderImpl.getProviderAcceptHeader(), acceptHeaderLiteral, providerInstanceUri);
		    ...
		    if(getEndpointUrls() != null)
		    {
		        for(String nextEndpointUrl : getEndpointUrls())
		        {
		            ...
		            {
		                con.add(providerInstanceUri, HttpProviderImpl.getProviderEndpointUrl(), f.createLiteral(nextEndpointUrl), providerInstanceUri);
		            }
		        }
		    }

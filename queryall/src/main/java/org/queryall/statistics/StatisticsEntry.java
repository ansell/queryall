...
public class StatisticsEntry implements BaseQueryAllInterface
{
    ...
    /**
     * @param profileUris the profileUris to set
     */
    ...
    /**
     * @param successfulproviderUris the successfulproviderUris to set
     */
    ...
    /**
     * @param errorproviderUris the errorproviderUris to set
     */
    ...
    /**
     * @param querytypeUris the querytypeUris to set
     */
    ...
    /**
     * @param namespaceUris the namespaceUris to set
     */
    ...
    /**
     * @param userHostAddress the userHostAddress to set
     */
    ...
    /**
     * @param realHostName the realHostName to set
     */
    ...
    /**
     * @param sumLatency the sumLatency to set
     */
    ...
    /**
     * @param sumQueries the sumQueries to set
     */
    ...
    /**
     * @param stdevlatency the stdevlatency to set
     */
    ...
    /**
     * @param sumerrors the sumerrors to set
     */
    ...
    /**
     * @param sumerrorlatency the sumerrorlatency to set
     */
    ...
    /**
     * @param stdeverrorlatency the stdeverrorlatency to set
     */
    ...
    // Start of Settings.getStringPropertyFromConfig("statisticsServerUrl")_VERSION=1 fields
    ...
    // End of Settings.getStringPropertyFromConfig("statisticsServerUrl")_VERSION=1 fields
    ...
    static URI statisticsTypeUri;
    static URI statisticskeyUri;
    static URI statisticsprofileUrisUri;
    static URI statisticscurrentdatetimeUri;
    static URI statisticssuccessfulproviderUrisUri;
    static URI statisticserrorproviderUrisUri;
    static URI statisticsconfigLocationsUri;
    static URI statisticsquerytypeUrisUri;
    static URI statisticsnamespaceUrisUri;
    static URI statisticsconfigVersionUri;
    static URI statisticsreadtimeoutUri;
    static URI statisticsconnecttimeoutUri;
    static URI statisticsuserHostAddressUri;
    static URI statisticsuserAgentUri;
    static URI statisticsrealHostNameUri;
    static URI statisticsqueryStringUri;
    static URI statisticsresponseTimeUri;
    static URI statisticssumLatencyUri;
    static URI statisticssumQueriesUri;
    static URI statisticsstdevlatencyUri;
    static URI statisticssumerrorsUri;
    static URI statisticssumerrorlatencyUri;
    static URI statisticsstdeverrorlatencyUri;
    static URI statisticslastServerRestartUri;
    static URI statisticsserverSoftwareVersionUri;
    static URI statisticsacceptHeaderUri;
    static URI statisticsrequestedContentTypeUri;
    ...
    public static boolean schemaToRdf(Repository myRepository, String keyToUse, int modelVersion) throws OpenRDFException
    {
        ...
        try
        {
            ...
            con.add(statisticskeyUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            
            con.add(statisticsprofileUrisUri, RDF.TYPE, OWL.OBJECTPROPERTY, contextKeyUri);
            con.add(statisticsquerytypeUrisUri, RDF.TYPE, OWL.OBJECTPROPERTY, contextKeyUri);
            
            con.add(statisticscurrentdatetimeUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticssuccessfulproviderUrisUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticserrorproviderUrisUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsconfigLocationsUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsnamespaceUrisUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsconfigVersionUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsreadtimeoutUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsconnecttimeoutUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsuserHostAddressUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsuserAgentUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsrealHostNameUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsqueryStringUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsresponseTimeUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticssumLatencyUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticssumQueriesUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsstdevlatencyUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticssumerrorsUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticssumerrorlatencyUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsstdeverrorlatencyUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticslastServerRestartUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsserverSoftwareVersionUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsacceptHeaderUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
            con.add(statisticsrequestedContentTypeUri, RDF.TYPE, OWL.DATATYPEPROPERTY, contextKeyUri);
    ...
    static
    {
        ...
        try
        {
            ...
            StatisticsEntry.statisticsTypeUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "Statistics");
            StatisticsEntry.statisticskeyUri = f
                    .createURI(StatisticsEntry.statisticsNamespace + "key");
            
            StatisticsEntry.statisticscurrentdatetimeUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "submissionDate");
            StatisticsEntry.statisticsprofileUrisUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "profileUri");
            StatisticsEntry.statisticssuccessfulproviderUrisUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "successfulProviderUri");
            StatisticsEntry.statisticserrorproviderUrisUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "errorProviderUri");
            StatisticsEntry.statisticsconfigLocationsUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "configLocation");
            StatisticsEntry.statisticsquerytypeUrisUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "querytypeUri");
            StatisticsEntry.statisticsnamespaceUrisUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "namespaceUri");
            StatisticsEntry.statisticsconfigVersionUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "configVersion");
            StatisticsEntry.statisticsreadtimeoutUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "readtimeout");
            StatisticsEntry.statisticsconnecttimeoutUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "connecttimeout");
            StatisticsEntry.statisticsuserHostAddressUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "userHostAddress");
            StatisticsEntry.statisticsuserAgentUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "userAgent");
            StatisticsEntry.statisticsrealHostNameUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "realHostName");
            StatisticsEntry.statisticsqueryStringUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "queryString");
            StatisticsEntry.statisticsresponseTimeUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "responseTime");
            StatisticsEntry.statisticssumLatencyUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "sumLatency");
            StatisticsEntry.statisticssumQueriesUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "sumQueries");
            StatisticsEntry.statisticsstdevlatencyUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "stdevlatency");
            StatisticsEntry.statisticssumerrorsUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "sumerrors");
            StatisticsEntry.statisticssumerrorlatencyUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "sumerrorlatency");
            StatisticsEntry.statisticsstdeverrorlatencyUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "stdeverrorlatency");
            
            StatisticsEntry.statisticslastServerRestartUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "lastServerRestart");
            StatisticsEntry.statisticsserverSoftwareVersionUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "serverSoftwareVersion");
            StatisticsEntry.statisticsacceptHeaderUri = f
                    .createURI(StatisticsEntry.statisticsNamespace
                            + "acceptHeader");
            StatisticsEntry.statisticsrequestedContentTypeUri = f.createURI(StatisticsEntry.statisticsNamespace+ "requestedContentType");
        }
        catch (final RepositoryException re)
        {
            StatisticsEntry.log.error(re.getMessage());
        }
    }
    ...
    public boolean toRdf(Repository myRepository, URI keyToUse, int modelVersion) throws OpenRDFException
    {
        ...
        try
        {
            ...
            connection.add(keyUri,
                    StatisticsEntry.statisticsacceptHeaderUri,
            ...
            if(this.profileUris != null)
            {
                for(final String nextProfileUri : this.profileUris)
                {
                    if(!nextProfileUri.trim().equals(""))
                    {
                        connection.add(keyUri,
                                StatisticsEntry.statisticsprofileUrisUri, f
                                        .createURI(nextProfileUri), keyUri);
                    }
                }
            }
                    ...
                    if(!nextSuccessfulProvidersUri.trim().equals(""))
                    {
                        connection
                                .add(
                                        ...
                                        f
                                                .createLiteral(nextSuccessfulProvidersUri),
                                        keyUri);
                    }
                }
            }
            ...
            if(this.configLocations != null)
            {
                for(final String nextConfigLocation : this.configLocations)
                {
                    if(!nextConfigLocation.trim().equals(""))
                    {
                        connection.add(keyUri,
                                StatisticsEntry.statisticsconfigLocationsUri, f
                                        .createLiteral(nextConfigLocation),
                                keyUri);
                    }
                }
            }
            ...
            if(this.querytypeUris != null)
            {
                for(final String nextQuerytypeUri : this.querytypeUris)
                {
                    if(!nextQuerytypeUri.trim().equals(""))
                    {
                        connection.add(keyUri,
                                StatisticsEntry.statisticsquerytypeUrisUri, f
                                        .createURI(nextQuerytypeUri), keyUri);
                    }
                }
            }
            ...
            if(this.namespaceUris != null)
            {
                for(final String nextNamespaceUri : this.namespaceUris)
                {
                    if(!nextNamespaceUri.trim().equals(""))
                    {
                        connection.add(keyUri,
                                StatisticsEntry.statisticsnamespaceUrisUri, f
                                        .createURI(nextNamespaceUri), keyUri);
                    }
                }
            }

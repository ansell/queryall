...
public interface ProfilableInterface extends BaseQueryAllInterface
{
    ...
    /**
     * This method determines whether this class should be included or excluded, 
     * based on the pre-ordered profile list and the parameters which indicate 
     * whether implicit inclusions are allowed and whether this method will 
     * match if no profiles match at all
     * @param orderedProfileList a pre sorted list of profiles that will be used in sequence to determine whether this object will be used
     * @param allowImplicitInclusions true if implicit inclusions are acceptable, and false if implicit inclusions should be ignored and the profile list should be processed until and explicit match is found

...
public class ProfileSchema
{
        ...
        throws OpenRDFException
    {
        ...
        try
        {
            ...
            con.add(ProfileSchema.getProfileOrderUri(), RDFS.LABEL, f.createLiteral("."), contextUri);
            ...
            con.add(ProfileSchema.getProfileAdministratorUri(), RDFS.DOMAIN, ProfileSchema.getProfileTypeUri(),
                    contextUri);
            con.add(ProfileSchema.getProfileAdministratorUri(), RDFS.LABEL, f.createLiteral("."), contextUri);
            ...
            con.add(ProfileSchema.getProfileDefaultIncludeExcludeOrderUri(), RDFS.LABEL, f.createLiteral("."),
                    contextUri);
            ...
            con.add(ProfileSchema.getProfileAllowImplicitQueryInclusionsUri(), RDFS.DOMAIN,
                    ProfileSchema.getProfileTypeUri(), contextUri);
            con.add(ProfileSchema.getProfileAllowImplicitQueryInclusionsUri(), RDFS.LABEL, f.createLiteral("."),
                    contextUri);
            ...
            con.add(ProfileSchema.getProfileAllowImplicitProviderInclusionsUri(), RDFS.DOMAIN,
                    ProfileSchema.getProfileTypeUri(), contextUri);
            con.add(ProfileSchema.getProfileAllowImplicitProviderInclusionsUri(), RDFS.LABEL, f.createLiteral("."),
                    contextUri);
            ...
            con.add(ProfileSchema.getProfileAllowImplicitRdfRuleInclusionsUri(), RDFS.DOMAIN,
                    ProfileSchema.getProfileTypeUri(), contextUri);
            con.add(ProfileSchema.getProfileAllowImplicitRdfRuleInclusionsUri(), RDFS.LABEL, f.createLiteral("."),
                    contextUri);
            ...
            con.add(ProfileSchema.getProfileIncludeProviderInProfile(), RDFS.DOMAIN, ProfileSchema.getProfileTypeUri(),
                    contextUri);
            con.add(ProfileSchema.getProfileIncludeProviderInProfile(), RDFS.LABEL, f.createLiteral("."), contextUri);
            ...
            con.add(ProfileSchema.getProfileExcludeProviderFromProfile(), RDFS.DOMAIN,
                    ProfileSchema.getProfileTypeUri(), contextUri);
            con.add(ProfileSchema.getProfileExcludeProviderFromProfile(), RDFS.LABEL, f.createLiteral("."), contextUri);
            ...
            con.add(ProfileSchema.getProfileIncludeQueryInProfile(), RDFS.DOMAIN, ProfileSchema.getProfileTypeUri(),
                    contextUri);
            con.add(ProfileSchema.getProfileIncludeQueryInProfile(), RDFS.LABEL, f.createLiteral("."), contextUri);
            ...
            con.add(ProfileSchema.getProfileExcludeQueryFromProfile(), RDFS.DOMAIN, ProfileSchema.getProfileTypeUri(),
                    contextUri);
            con.add(ProfileSchema.getProfileExcludeQueryFromProfile(), RDFS.LABEL, f.createLiteral("."), contextUri);
            ...
            con.add(ProfileSchema.getProfileIncludeRdfRuleInProfile(), RDFS.DOMAIN, ProfileSchema.getProfileTypeUri(),
                    contextUri);
            con.add(ProfileSchema.getProfileIncludeRdfRuleInProfile(), RDFS.LABEL, f.createLiteral("."), contextUri);
            ...
            con.add(ProfileSchema.getProfileExcludeRdfRuleFromProfile(), RDFS.DOMAIN,
                    ProfileSchema.getProfileTypeUri(), contextUri);
            con.add(ProfileSchema.getProfileExcludeRdfRuleFromProfile(), RDFS.LABEL, f.createLiteral("."), contextUri);
            
            con.add(ProfileSchema.getProfileExcludeThenIncludeUri(), RDF.TYPE, OWL.OBJECTPROPERTY, contextUri);
            con.add(ProfileSchema.getProfileExcludeThenIncludeUri(), RDFS.RANGE, RDFS.RESOURCE, contextUri);
            con.add(ProfileSchema.getProfileExcludeThenIncludeUri(), RDFS.DOMAIN, ProfileSchema.getProfileTypeUri(),
                    contextUri);
            con.add(ProfileSchema.getProfileExcludeThenIncludeUri(), RDFS.LABEL, f.createLiteral("."), contextUri);
            
            con.add(ProfileSchema.getProfileIncludeThenExcludeUri(), RDF.TYPE, OWL.OBJECTPROPERTY, contextUri);
            con.add(ProfileSchema.getProfileIncludeThenExcludeUri(), RDFS.RANGE, RDFS.RESOURCE, contextUri);
            con.add(ProfileSchema.getProfileIncludeThenExcludeUri(), RDFS.DOMAIN, ProfileSchema.getProfileTypeUri(),
                    contextUri);
            con.add(ProfileSchema.getProfileIncludeThenExcludeUri(), RDFS.LABEL, f.createLiteral("."), contextUri);
            
            con.add(ProfileSchema.getProfileIncludeExcludeOrderUndefinedUri(), RDF.TYPE, OWL.OBJECTPROPERTY, contextUri);
            con.add(ProfileSchema.getProfileIncludeExcludeOrderUndefinedUri(), RDFS.RANGE, RDFS.RESOURCE, contextUri);
            con.add(ProfileSchema.getProfileIncludeExcludeOrderUndefinedUri(), RDFS.DOMAIN,
                    ProfileSchema.getProfileTypeUri(), contextUri);
            con.add(ProfileSchema.getProfileIncludeExcludeOrderUndefinedUri(), RDFS.LABEL, f.createLiteral("."),
                    contextUri);

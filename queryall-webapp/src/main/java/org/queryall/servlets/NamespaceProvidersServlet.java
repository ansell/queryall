...
public class NamespaceProvidersServlet extends HttpServlet
{
        ...
        IOException
    {
        ...
        final StringBuilder rdfStrings = new StringBuilder();
        ...
        for(final URI nextUniqueQuery : providersByQueryKey.keySet())
        {
            ...
            if(implementedNamespacesForNextQuery.size() > 0
                    && localSettings.getURIProperties("autogenerateIncludeStubList").contains(nextUniqueQuery))
            {
                final StringBuilder sb = new StringBuilder();
                
                final String shortQueryName =
                        ((Settings)localSettings).getAutogeneratedQueryPrefix()
                                + StringUtils.md5(StringUtils.percentEncode(nextUniqueQuery.stringValue())
                                        + localSettings.getStringProperty("separator", "") + now
                                        + localSettings.getStringProperty("separator", ""))
                                + ((Settings)localSettings).getAutogeneratedQuerySuffix();
                
                final String queryName =
                        localSettings.getDefaultHostAddress() + localSettings.getNamespaceForQueryType()
                                + localSettings.getStringProperty("separator", "") + shortQueryName;
                
                final String shortProviderName =
                        ((Settings)localSettings).getAutogeneratedProviderPrefix()
                                + StringUtils.md5(StringUtils.percentEncode(nextUniqueQuery.stringValue())
                                        + localSettings.getStringProperty("separator", "") + now
                                        + localSettings.getStringProperty("separator", ""))
                                + ((Settings)localSettings).getAutogeneratedProviderSuffix();
                
                final String providerName =
                        localSettings.getDefaultHostAddress() + localSettings.getNamespaceForProvider()
                                + localSettings.getStringProperty("separator", "") + shortProviderName;
                
                final StringBuilder namespacesForThisQuery = new StringBuilder();
                ...
                sb.append(StringUtils.xmlEncodeString("<" + queryName + "> a <http://purl.org/queryall/query:Query> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:isPageable> \"false\"^^<http://www.w3.org/2001/XMLSchema#boolean> ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/dc/elements/1.1/title> \""
                        + StringUtils.ntriplesEncode(shortQueryName) + "\" ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:handleAllNamespaces> \"false\"^^<http://www.w3.org/2001/XMLSchema#boolean> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:isNamespaceSpecific> \"true\"^^<http://www.w3.org/2001/XMLSchema#boolean> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:namespaceMatchMethod> <http://purl.org/queryall/query:namespaceMatchAny> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:includeDefaults> \"false\"^^<http://www.w3.org/2001/XMLSchema#boolean> ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/query:inputRegex> \""
                        + StringUtils.ntriplesEncode(localSettings.getStringProperty(
                                "plainNamespaceAndIdentifierRegex", "")) + "\" ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/query:templateString> \"\" ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:queryUriTemplateString> \"${defaultHostAddress}${input_1}${defaultSeparator}${input_2}\" ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:standardUriTemplateString> \"${defaultHostAddress}${input_1}${defaultSeparator}${input_2}\" ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/query:outputRdfXmlString> \"\" ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:inRobotsTxt> \"false\"^^<http://www.w3.org/2001/XMLSchema#boolean> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/profile:profileIncludeExcludeOrder> <http://purl.org/queryall/profile:excludeThenInclude> ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/query:namespaceToHandle> "
                        + namespacesForThisQuery.toString() + " ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:hasPublicIdentifierIndex> \"1\"^^<http://www.w3.org/2001/XMLSchema#int> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/query:hasNamespaceInputIndex> \"1\"^^<http://www.w3.org/2001/XMLSchema#int> ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/query:includeQueryType> <"
                        + nextUniqueQuery + "> .")
                        + "<br />\n<br />\n");
                
                sb.append(StringUtils.xmlEncodeString("<" + providerName
                        + "> a <http://purl.org/queryall/provider:Provider> ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/provider:Title> \""
                        + StringUtils.ntriplesEncode(shortProviderName) + "\" ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/provider:resolutionStrategy> <http://purl.org/queryall/provider:proxy> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/provider:resolutionMethod> <http://purl.org/queryall/provider:nocommunication> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/provider:isDefaultSource> \"false\"^^<http://www.w3.org/2001/XMLSchema#boolean> ;")
                        + "<br />\n");
                sb.append(StringUtils
                        .xmlEncodeString("<http://purl.org/queryall/profile:profileIncludeExcludeOrder> <http://purl.org/queryall/profile:excludeThenInclude> ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/provider:includedInQuery> <"
                        + queryName + "> ;")
                        + "<br />\n");
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/provider:handlesNamespace> "
                        + namespacesForThisQuery.toString() + " . ")
                        + "<br /><br />\n");

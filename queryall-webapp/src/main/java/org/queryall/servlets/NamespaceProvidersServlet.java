...
public class NamespaceProvidersServlet extends HttpServlet 
{
        ...
        throws ServletException, IOException 
    {
        ...
        for(URI nextUniqueQuery : providersByQueryKey.keySet())
        {
            ...
            if(implementedNamespacesForNextQuery.size() > 0 && localSettings.getURICollectionPropertiesFromConfig("autogenerateIncludeStubList").contains(nextUniqueQuery))
            {
                ...
                sb.append(StringUtils.xmlEncodeString("<http://purl.org/queryall/query:inputRegex> \""+StringUtils.ntriplesEncode(localSettings.getStringPropertyFromConfig("plainNamespaceAndIdentifierRegex", ""))+"\" ;")+"<br />\n");

...
public class StatementComparatorTest
{
    ...
    public void testCompareEquivalentBothNullContexts()
    {
        ...
        Assert.assertEquals(0, testComparator.compare(statement1, statement2));
        Assert.assertEquals(0, testComparator.compare(statement2, statement1));
    }
    ...
    public void testCompareEquivalentOneNullOneURIContext()
    {
        ...
        Assert.assertTrue(testComparator.compare(statement1, statement2) < 0);
        Assert.assertTrue(testComparator.compare(statement2, statement1) > 0);
    }
    ...
    public void testCompareEquivalentOneNullOneBNodeContext()
    {
        statement1 = valueFactory.createStatement(testSubjectUri1, testPredicateUri1, testObjectUri1, null);
        statement2 =
                valueFactory.createStatement(testSubjectUri1, testPredicateUri1, testObjectUri1, testContextBNode1);

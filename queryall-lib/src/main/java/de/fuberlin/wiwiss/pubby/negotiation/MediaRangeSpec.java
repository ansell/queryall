...
public class MediaRangeSpec
{
    ...
    public static List<MediaRangeSpec> parseAccept(String s)
    {
        ...
        Matcher m = MediaRangeSpec.mediaRangePattern.matcher(s);
        while(m.find())
        {
    ...
    private MediaRangeSpec(String type, String subtype, List<String> parameterNames, List<String> parameterValues,
            double quality)
    {
        this.type = type;

...
public class HttpProviderImpl extends ProviderImpl implements HttpProvider, SparqlProvider
{
    ...
    public HttpProviderImpl(Collection<Statement> inputStatements, URI keyToUse, int modelVersion)
     ...
     */
    public static void setProviderHttpProviderUri(URI providerHttpProviderUri)
    {
     ...
     */
    public static void setProviderSparqlProviderUri(URI providerSparqlProviderUri)
    {

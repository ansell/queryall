 ...
 */
public class HttpNoCommunicationProviderImplParser implements ProviderParser
{
    @Override
        ...
        throws IllegalArgumentException
    {
        try
        {
            return new HttpNoCommunicationProviderImpl(rdfStatements, subjectKey, modelVersion);
        }

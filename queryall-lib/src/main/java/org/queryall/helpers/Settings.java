...
public class Settings implements QueryAllConfiguration
{
    ...
    public synchronized boolean configRefreshCheck(boolean tryToForceRefresh)
    {
        ...
        boolean enablePeriodicConfigurationRefresh =
                this.getBooleanProperty("enablePeriodicConfigurationRefresh", true);
     ...
     */
    public void setAutogeneratedProviderPrefix(String aUTOGENERATED_PROVIDER_PREFIX)
    {
     ...
     */
    public void setAutogeneratedProviderSuffix(String aUTOGENERATED_PROVIDER_SUFFIX)
    {
     ...
     */
    @Override
    public void setNamespaceForNamespaceEntry(String current_RDF_NAMESPACEENTRY_NAMESPACE)
    {
     ...
     */
    @Override
    public void setNamespaceForNormalisationRule(String current_RDF_RDFRULE_NAMESPACE)
    {
     ...
     */
    @Override
    public void setNamespaceForProvenance(String current_RDF_PROVENANCE_NAMESPACE)
    {
     ...
     */
    @Override
    public void setNamespaceForQueryBundle(String current_RDF_QUERYBUNDLE_NAMESPACE)
    {
     ...
     */
    @Override
    public void setNamespaceForStatistics(String current_RDF_STATISTICS_NAMESPACE)
    {
    ...
    private synchronized Repository getBaseConfigurationRdf() throws java.lang.InterruptedException
    {
        ...
        if(Settings._TRACE)
        {
            try
            {
                for(Statement nextStatement : RdfUtils
    ...
    private Collection<Value> getValueProperties(URI subjectUri, URI propertyUri)
    {
        ...
        else
        {
            ...
            {
                results =
                        RdfUtils.getValuesFromRepositoryByPredicateUrisAndSubject(getWebAppConfigurationRdf(),
    ...
    private synchronized Repository getWebAppConfigurationRdf() throws java.lang.InterruptedException
    {
        ...
        try
        {
            ...
            Collection<Value> activeWebappConfigs =
                    RdfUtils.getValuesFromRepositoryByPredicateUrisAndSubject(nextBaseConfigurationRepository,
     ...
     */
    public void setNamespacePrefixesToUris(Map<String, Collection<URI>> cachedNamespacePrefixToUriEntries)
    {

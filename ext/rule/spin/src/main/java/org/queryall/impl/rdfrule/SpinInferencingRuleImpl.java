...
public class SpinInferencingRuleImpl extends BaseTransformingRuleImpl implements SpinInferencingRule, HtmlExport
{
        ...
        throws QueryAllException
    {
        ...
        final Map<Resource, List<CommandWrapper>> cls2Query =
                SPINQueryFinder.getClass2QueryMap(unionModel, queryModel, SPIN.rule, true, false);
        // FIXME: Get the patch for the following working again
        // , allowedRuleSources);
        final Map<Resource, List<CommandWrapper>> cls2Constructor =
                SPINQueryFinder.getClass2QueryMap(queryModel, queryModel, SPIN.constructor, true, false);
        // FIXME: Get the patch for the following working again
        // , allowedRuleSources);
        ...
        SPINInferences.run(queryModel, newTriples, cls2Query, cls2Constructor, null, null, false, SPIN.rule,
                comparator, null);
        // FIXME: Get the patch for the following working again
        // , allowedRuleSources);
